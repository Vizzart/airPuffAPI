...
def calculateIternalMandami(airlyCurrentMeassurment, espCurrentMeasurment, airlyForecastMeasurment):
    ...
    airlyCurrentVeryLow = fuzz.interp_membership(airly_current, airly_current_1, airlyCurrentMeassurment)
    airlyCurrentLow = fuzz.interp_membership(airly_current, airly_current_2, airlyCurrentMeassurment)
    airlyCurrentMid = fuzz.interp_membership(airly_current, airly_current_3, airlyCurrentMeassurment)
    airlyCurrentHigh = fuzz.interp_membership(airly_current, airly_current_4, airlyCurrentMeassurment)
    airlyCurrentVeryHigh = fuzz.interp_membership(airly_current, airly_current_5, airlyCurrentMeassurment)

    espCurrentVeryLow = fuzz.interp_membership(esp_current, esp_current_1, espCurrentMeasurment)
    espCurrentLow = fuzz.interp_membership(esp_current, esp_current_2, espCurrentMeasurment)
    espCurrentMid = fuzz.interp_membership(esp_current, esp_current_3, espCurrentMeasurment)
    espCurrentHigh = fuzz.interp_membership(esp_current, esp_current_4, espCurrentMeasurment)
    espCurrentVeryHigh = fuzz.interp_membership(esp_current, esp_current_5, espCurrentMeasurment)

    airlyForecastVeryLow = fuzz.interp_membership(airly_forecast, airly_forecast_1, airlyForecastMeasurment)
    airlyForecastLow  = fuzz.interp_membership(airly_forecast, airly_forecast_2, airlyForecastMeasurment)
    airlyForecastMid = fuzz.interp_membership(airly_forecast, airly_forecast_3, airlyForecastMeasurment)
    airlyForecastHigh = fuzz.interp_membership(airly_forecast, airly_forecast_4, airlyForecastMeasurment)
    airlyForecastVeryHigh = fuzz.interp_membership(airly_forecast, airly_forecast_5, airlyForecastMeasurment)


    ###############################################################
    #IF
    active_rule_1 = espCurrentVeryLow
    fan_action_1 = np.fmin(active_rule_1, fun_level_1)
    ###############################################################
    active_rule_2 = espCurrentLow
    fan_action_2  = np.fmin(active_rule_2, fun_level_2)
    ###############################################################
    active_rule_3 = espCurrentMid
    fan_action_3  = np.fmin(active_rule_3, fun_level_3)
    ###############################################################
    active_rule_4 = espCurrentHigh
    fan_action_4  = np.fmin(active_rule_4, fun_level_4)
    ###############################################################
    active_rule_5 = espCurrentHigh
    fan_action_5  = np.fmin(active_rule_5, fun_level_5)
    ###############################################################

    active_rule_6 = np.fmin(airlyCurrentVeryLow, airlyForecastVeryLow)* 0.5 # and
    fan_action_6 = np.fmin(active_rule_6, fun_level_1)
    ###############################################################
    active_rule_7 = np.fmin(airlyCurrentVeryLow, airlyForecastLow)* 0.5 # and
    fan_action_7 = np.fmin(active_rule_7, fun_level_2)
    ###############################################################
    active_rule_8 = np.fmin(airlyCurrentVeryLow, airlyForecastMid)* 0.5 # and
    fan_action_8 = np.fmin(active_rule_8, fun_level_3)
    ###############################################################
    active_rule_9 = np.fmin(airlyCurrentVeryLow, airlyCurrentHigh)* 0.5 # and
    fan_action_9 = np.fmin(active_rule_9, fun_level_4)
    ###############################################################
    active_rule_10 = np.fmin(airlyCurrentVeryLow, airlyCurrentVeryHigh)* 0.5 # and
    fan_action_10 = np.fmin(active_rule_10, fun_level_5)
    ###############################################################

    active_rule_11 = np.fmin(airlyCurrentLow, airlyForecastVeryLow)* 0.5 # and
    fan_action_11 = np.fmin(active_rule_11, fun_level_2)
    ###############################################################
    active_rule_12 = np.fmin(airlyCurrentLow, airlyForecastLow)* 0.5 # and
    fan_action_12 = np.fmin(active_rule_12, fun_level_2)
    ###############################################################
    active_rule_13 = np.fmin(airlyCurrentLow, airlyForecastMid)* 0.5 # and
    fan_action_13 = np.fmin(active_rule_13, fun_level_3)
    ###############################################################
    active_rule_14 = np.fmin(airlyCurrentLow, airlyForecastHigh)* 0.5 # and
    fan_action_14 = np.fmin(active_rule_14, fun_level_4)
    ###############################################################
    active_rule_15 = np.fmin(airlyCurrentLow, airlyForecastVeryHigh)* 0.5 # and
    fan_action_15 = np.fmin(active_rule_15, fun_level_5)
    ###############################################################

    active_rule_16 = np.fmin(airlyCurrentMid, airlyForecastVeryLow)* 0.5 # and
    fan_action_16 = np.fmin(active_rule_16, fun_level_3)
    ###############################################################
    active_rule_17 = np.fmin(airlyCurrentMid, airlyForecastLow)* 0.5 # and
    fan_action_17 = np.fmin(active_rule_17, fun_level_3)
    ###############################################################
    active_rule_18 = np.fmin(airlyCurrentMid, airlyForecastMid)* 0.5 # and
    fan_action_18 = np.fmin(active_rule_18, fun_level_3)
    ###############################################################
    active_rule_19 = np.fmin(airlyCurrentMid, airlyForecastHigh)* 0.5 # and
    fan_action_19 = np.fmin(active_rule_19, fun_level_4)
    ###############################################################
    active_rule_20 = np.fmin(airlyCurrentMid, airlyForecastVeryHigh)* 0.5 # and
    fan_action_20 = np.fmin(active_rule_20, fun_level_5)
    ###############################################################

    active_rule_21 = np.fmin(airlyCurrentHigh, airlyForecastVeryLow)* 0.5 # and
    fan_action_21 = np.fmin(active_rule_21, fun_level_4)
    ###############################################################
    active_rule_22 = np.fmin(airlyCurrentHigh, airlyForecastLow)* 0.5 # and
    fan_action_22 = np.fmin(active_rule_22, fun_level_4)
    ###############################################################
    active_rule_23 = np.fmin(airlyCurrentHigh, airlyForecastMid)* 0.5 # and
    fan_action_23 = np.fmin(active_rule_23, fun_level_4)
    ###############################################################
    active_rule_24 = np.fmin(airlyCurrentHigh, airlyForecastHigh)* 0.5 # and
    fan_action_24 = np.fmin(active_rule_24, fun_level_4)
    ###############################################################
    active_rule_25 = np.fmin(airlyCurrentHigh, airlyForecastVeryHigh)* 0.5 # and
    fan_action_25 = np.fmin(active_rule_25, fun_level_5)
    ###############################################################
    active_rule_26 = np.fmin(airlyCurrentVeryHigh, airlyForecastVeryLow)* 0.5 # and
    fan_action_26 = np.fmin(active_rule_26, fun_level_5)
    ###############################################################
    active_rule_27 = np.fmin(airlyCurrentVeryHigh, airlyForecastLow)* 0.5 # and
    fan_action_27 = np.fmin(active_rule_27, fun_level_5)
    ###############################################################
    active_rule_28 = np.fmin(airlyCurrentVeryHigh, airlyForecastMid)* 0.5 # and
    fan_action_28 = np.fmin(active_rule_28, fun_level_5)
    ###############################################################
    active_rule_29 = np.fmin(airlyCurrentVeryHigh, airlyForecastHigh)* 0.5 # and
    fan_action_29 = np.fmin(active_rule_29, fun_level_5)
    ###############################################################
    active_rule_30 = np.fmin(airlyCurrentVeryHigh, airlyForecastVeryHigh)* 0.5 # and
    fan_action_30 = np.fmin(active_rule_30, fun_level_5)
    ###############################################################
    ...
    aggregate = np.fmax(fan_action_1,
                ...
                np.fmax(fan_action_27,
                np.fmax(fan_action_28,
                np.fmax(fan_action_29,fan_action_30))))))))))))))))))))))))))))))
